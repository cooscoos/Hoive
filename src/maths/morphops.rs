...
pub fn dilate<T: Coord>(coord: &T, binary_img: &HashSet<(i8, i8, i8)>) -> HashSet<(i8, i8, i8)> {
...
pub fn erode<T: Coord>(coord: &T, binary_img: &HashSet<(i8, i8, i8)>) -> HashSet<(i8, i8, i8)> {
    //Hashset for keeping track of chip locations
    let mut store: HashSet<(i8, i8, i8)> = HashSet::new();
...
pub fn close<T: Coord>(coord: &T, binary_img: &HashSet<(i8, i8, i8)>) -> HashSet<(i8, i8, i8)> {
...
/// closing operation.
pub fn close_new<T: Coord>(coord: &T, binary_img: &HashSet<(i8, i8, i8)>) -> HashSet<(i8, i8, i8)> {
    // Do the closure
