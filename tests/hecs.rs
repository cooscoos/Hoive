...
//     pmoore::try_move(&mut board, "a1", Team::Black, (1, 0, 0));
//     assert_eq!(
//         MoveStatus::Success,
//         pmoore::try_move(&mut board, "a1", Team::White, (0, 1, 0))
//     );
// }
...
//     let mut board = Board::test_board(Hecs);
//     pmoore::try_move(&mut board, "q1", Team::Black, (1, 0, 0));
//     pmoore::try_move(&mut board, "q1", Team::White, (0, 1, 0));
//     pmoore::try_move(&mut board, "a2", Team::Black, (0, 0, 0));
//     pmoore::try_move(&mut board, "a2", Team::White, (1, 1, 0));

//     assert_eq!(
//         MoveStatus::BadNeighbour,
//         pmoore::try_move(&mut board, "a3", Team::Black, (1, 1, 1))
//     );
// }
...
//     pmoore::try_move(&mut board, "a1", Team::White, (0, 1, 0));
//     pmoore::try_move(&mut board, "a2", Team::Black, (0, 0, 0));
//     pmoore::try_move(&mut board, "q1", Team::White, (1, 1, 0));

//     assert_eq!(
//         MoveStatus::HiveSplit,
//         pmoore::try_move(&mut board, "a1", Team::White, (1, 1, 1))
//     );
// }
...
//     pmoore::try_move(&mut board, "a2", Team::Black, (0, 0, 0));
//     pmoore::try_move(&mut board, "a2", Team::White, (1, 1, 0));
//     pmoore::try_move(&mut board, "a3", Team::White, (1, 1, -1));
//     pmoore::try_move(&mut board, "a4", Team::White, (0, 2, 0));

//     assert_eq!(
//         MoveStatus::Success,
//         pmoore::try_move(&mut board, "a3", Team::White, (0, 0, 1))
//     );
// }
...
//     assert_eq!(
//         MoveStatus::Success,
//         pmoore::try_move(&mut board, "a3", Team::White, (1, 2, 0))
//     );
// }
